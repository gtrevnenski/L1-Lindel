...
Only store the first 536 features: deletion alleles. Normalize so that probabilities of all deletions sum to 1, because
we only consider deletions in this part of the model.'''
Seq_train = Seqs[idx]
x_train,x_valid = [],[]
y_train,y_valid = [],[]
